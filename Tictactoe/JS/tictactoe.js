...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/sonic.jpg")';
            //Active player may only be 'X' or 'O', the o.png is placed in HTML.
        } else {
            //If activePlayer is equal to 'O', the o.png is placed in HTML.
            select.style.backgroundImage = 'url("images/eggman.jpg")';
        }
        ...
        if(activePlayer==='O'){audio('media/jump.mp3');}
        else if(activePlayer==='X'){audio('media/ha.mp3');}
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.moveTo(x1, y1)
        //This method indicates teh end point in our line.
        c.lineTo(x, y)
        //This method sets the width of our line.
        c.lineWidth = 10;
        //This method sets the color of our line.
        c.strokeStyle = "rgb(248, 237, 28)";
        ...
        //This is necessary for teh 6, 4, 2 win condition
        if (x1 <= x2 && y1 >= y2) {
            if (x < x2) { x += 10; }
            if (y > y2) { y -= 10; }
            if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop); }
   ...
   if(activePlayer==='X') {audio('media/winGame.mp3');}
   else if(activePlayer==='O') {audio('media/Lose.mp3');}
    //This line calls our main aniation loop.
    animateLineDrawing();
